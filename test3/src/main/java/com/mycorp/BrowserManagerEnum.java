...
public enum BrowserManagerEnum {
	...
	CHROME("chrome"), FIREFOX("firefox"), EDGE("edge"), IE("ie"), MARIONETTE("marionette"), OPERA("opera"), PHANTOMJS(
			"phantomjs"), NONE("test");
	...
	public WebDriver getDriver() {
		...
		case EDGE:
			return Mockito.mock(EdgeDriver.class);
		case IE:
		...
		case MARIONETTE:
			return Mockito.mock(FirefoxDriver.class);
		case OPERA:
			return Mockito.mock(OperaDriver.class);
		case PHANTOMJS:
			return Mockito.mock(PhantomJSDriver.class);
		case NONE:
		default:
